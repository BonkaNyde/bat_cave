function submitContact() {
	if ($("#bookmark-form").valid()) {
		...
		var tablist = `
			<a class="contact-tab-${index_var} nav-link active" id="v-pills-user-tab" data-toggle="pill" onclick="activeDiv(${index_var})" href="#v-pills-user" role="tab" aria-controls="v-pills-user" aria-selected="true" data-original-title="" title="">
				<div class="media">
					...
					<div class="media-body">
						<h6>
							...
							<span class="last_name_${index_var}">${lastname}</span>
						</h6>
		...
		var tabcontent = `
			<div class="tab-pane contact-tab-${index_var} tab-content-child fade show active" id="v-pills-user" role="tabpanel" aria-labelledby="v-pills-user-tab">
				<div class="profile-mail">
					...
					<div class="media-body mt-0">
						...
						<ul>
							<li>
								<a href="javascript:void(0)" onclick="editContact(${index_var})" data-original-title="" title="">
									Edit
								</a>
							</li>
							<li>
								<a href="javascript:void(0)" onclick="deleteContact(${index_var})" data-original-title="" title="">
									Delete
								</a>
							</li>
							<li>
								<a href="javascript:void(0)" onclick="history(${index_var})" data-original-title="" title="">
									History
								</a>
							</li>
							<li>
								<a href="javascript:void(0)" onclick="printContact(${index_var})" data-toggle="modal" data-target="#printModal" data-original-title="" title="">
									Print
								</a>
							</li>
						</ul>
					...
					<h6>General</h6>
					<p>Email Address: 
						<span class="font-primary email_add_${index_var}">
						 	${mail}
						</span>
					</p>
				</div>

...
window.addEventListener('load', ()=>{
	if ('serviceWorker' in navigator){
		...
		navigator.serviceWorker.register('/teacher/service_worker.js')
		...
		console.warn('Service Worker not supported on this browser. Consider updating');
	}
});
...
// if('serviceWorker' in navigator){
//     let service_worker =  navigator.serviceWorker.register('/teacher/service_worker.js');
